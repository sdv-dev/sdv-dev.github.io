  ...
  return (
    <>
      ...
      >
        <div
          ref={tableScrollRef}
          className="overflow-x-auto lg:overflow-x-visible rounded-20"
          style={{
            scrollbarWidth: "none",
        ...
        >
          <div
            style={customStyles}
            className="w-full min-w-[750px] lg:min-w-0 lg:max-w-[750px] grid rounded-20 bg-white overflow-hidden border border-midnight-200"
          >
            {children}
          </div>
        </div>
