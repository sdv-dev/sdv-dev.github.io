    ...
    <>
      ...
      <div className="">
        <div className="viewport-top">
          ...
          <Navigation navClass="block px-3 py-4 mb:py-2 rounded-md text-base hover:underline-none focus:outline-none transition duration-150 ease-in-out navbar-item">
            <Link to="/">
              <div className="w-20">
                <Img
                  fadeIn={true}
    ...
    <StaticQuery
      query={graphql`
        query GhostSettings {
          ...
          logo: file(relativePath: { eq: "data-cebo-logo@2x.png" }) {
            childImageSharp {
