...
export default function NewsUpdate({
  imgSrc,
  imgDimensions = "md:h-[176px] min-w-[292px]",
  label,
  text,
  link,
}) {
    ...
    <div className="h-full">
      <div className="flex flex-col md:flex-row gap-6 h-full">
        <img
          src={imgSrc}
          alt="Illustration"
          className={`${imgDimensions} rounded-20 bg-[linear-gradient(270deg,_#F8F8F8_6.16%,_#F4F1F2_95.89%)] border border-midnight-50`}
        />
