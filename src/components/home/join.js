        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="px-4 w-full sm:w-8/12 md:w-7/12 text-center ">
            ...
            <p className="text-white mx-auto max-w-lg text-lg">
              Chat with developers across the world. Stay up-to-date with the
              latest features, blogs, and news.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto mt-8 mb-8">
        <div className="flex flex-wrap justify-center -mx-2">
          <div className="w-auto px-2 mb-4">
            ...
            >
              <span className="px-10 py-3 block rounded-full bg-sdv-dark">
                <span className="grad-txt">Twitter</span>
              </span>
            </a>
          </div>
          <div className="w-auto px-2 mb-4">
            ...
            >
              <span className="px-10 py-3 block rounded-full bg-sdv-dark">
                <span className=" grad-txt">Slack</span>
              </span>
            </a>
          </div>
          <div className="w-auto px-2 mb-4">
