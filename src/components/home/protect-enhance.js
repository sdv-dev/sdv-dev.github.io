...
export default function ProtectEnhance() {
  ...
  return (
    <section
      className="bg-sdv-dark relative pt-16 lg:pt-20 pb-20 lg:pb-40"
      id="sdv"
    >
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="px-4 w-full sm:w-8/12 md:w-7/12 text-center ">
            ...
            <p className="text-white mx-auto max-w-lg tracking-tight text-base font-light">
              Use a synthetic data in place of real data for added protection,
              or use it in addition to your real data as an enhancement.
            </p>
          </div>
        </div>
      </div>
              ...
              return (
                <div className="w-auto px-4 my-4" key={`usecase-${idx}`}>
                  <a
                    href={item.url}
                    rel="noreferrer"
                    className=" text-white hover:text-sdv-secondary hover:border-sdv-secondary duration-200 w-44 h-44 border-white border text-center rounded-2xl flex flex-col items-center justify-center"
                  >
                    <div className="mt-2 mb-3 mx-auto w-28 h-28">
                      {item.svg}
                    </div>
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="px-4 w-auto mb-10">
            <a
              ...
              rel="noreferrer"
            >
              <FontAwesomeIcon width="16" icon={faGithub} className="mr-3" />{" "}
              View on Github
            </a>
          </div>
        </div>
