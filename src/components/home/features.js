...
export default function Features() {
  const features = [
    ...
    },
    {
      ...
      docs: "",
      userguide:
        "https://colab.research.google.com/drive/1L6i-JhJK9ROG-KFcyzT9G-8FC3L8y8Lc?usp=sharing",
    },
    {
      svg: <Sequential />,
      ...
      docs: "",
      userguide:
        "https://colab.research.google.com/drive/1YLk2uwn8yrSRPy0soEeJwu8Hdk_tGTlE?usp=sharing",
    },
  ];
    ...
    <section className="relative z-10">
      <div className="container max-w-7xl mx-auto">
        <div className="flex flex-wrap -mx-4 -mt-40">
          {features.map((item) => {
            return (
              <div className="w-full sm:w-4/12 px-4 mb-4" key={item.name}>
