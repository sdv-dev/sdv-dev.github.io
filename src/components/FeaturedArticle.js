...
export default function FeaturedArticle(props) {
  ...
  return (
    <StaticQuery
      ...
      render={(data) => (
        <div
          className="flex flex-wrap rounded-10"
          style={{
            boxShadow: "0px 6px 40px rgba(153, 158, 178, 0.277153)",
          }}
        >
          <div className="w-full rounded-tl-10 rounded-bl-10 px-10 py-16 border md:w-5/12 border-t-stroke border-b-stroke border-l-stroke border-r-0 flex justify-center">
            <Img
              fadeIn={true}
          ...
          <div className="w-full rounded-r-10 border lg:w-7/12 xl:pl-28 lg:pl-20 pr-10 py-10">
            ...
            <div>
              ...
              <p>
                <Link to="#" className="text-sdv-link font-bold">Read more {' '}
