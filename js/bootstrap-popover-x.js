...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) { // jshint ignore:line
        ...
        define(['client/assets/js/jquery'], factory); // jshint ignore:line
    } else { // noinspection JSUnresolvedVariable
        if (typeof module === 'object' && module.exports) { // jshint ignore:line
            // Node/CommonJS
            // noinspection JSUnresolvedVariable
            module.exports = factory(require('client/assets/js/jquery')); // jshint ignore:line
        } else {
            // Browser globals
        ...
        listen: function (ev) {
            ...
            if (isHover) {
                ...
                $h.handler($el, ev, function (e) {
                    ...
                    if ( $(".kv-popover-active").css("display") === "block") {
